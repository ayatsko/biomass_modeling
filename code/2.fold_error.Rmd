...
load data
```{r}
tony_outputs_original <- read.csv("~/Desktop/Arbor_Meta/FireBreak_new/GitHub/repos/savanna/data/tony_output_original.csv")
tony_outputs_far <- read.csv("~/Desktop/Arbor_Meta/FireBreak_new/GitHub/repos/savanna/data/tony_output_far.csv")
...
```
```{r}
# Mean figures for results section
library(dplyr)
...
# Print the means in regular notation
print(means)
```
