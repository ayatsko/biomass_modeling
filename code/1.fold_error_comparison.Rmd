...
load data
```{r}
ALS_30m_0 <- read.csv("data/error_comparison_fold/split0/ALS_30m_0.csv")
CNN_30m_0 <- read.csv("data/error_comparison_fold/split0/CNN_30m_0.csv")

ALS_30m_1 <- read.csv("data/error_comparison_fold/split1/ALS_30m_1.csv")
CNN_30m_1 <- read.csv("data/error_comparison_fold/split1/CNN_30m_1.csv")

ALS_30m_46 <- read.csv("data/error_comparison_fold/split46/ALS_30m_46.csv")
CNN_30m_46 <- read.csv("data/error_comparison_fold/split46/CNN_30m_46.csv")

ALS_30m_51 <- read.csv("data/error_comparison_fold/split51/ALS_30m_51.csv")
CNN_30m_51 <- read.csv("data/error_comparison_fold/split51/CNN_30m_51.csv")
