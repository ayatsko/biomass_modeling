...
test1 <- rbind(split0_30m, split1_30m, split46_30m)
```
...
tony_split1_2_46 <- tony_outputs[tony_outputs$name == "all_train_test_splits_test_0" | tony_outputs$name == "all_train_test_splits_test_1" | tony_outputs$name == "Distance_blocks_Test_46", ]
tony_split1_2_46$split <- substr(tony_split1_2_46$name, nchar(tony_split1_2_46$name), nchar(tony_split1_2_46$name))
# if split = 6, change to 46 
tony_split1_2_46$split[tony_split1_2_46$split == "6"] <- "46"
